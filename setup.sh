...
sudo rm -f /etc/rc3.d/S01run_voco.sh
sudo rm -f /etc/rc4.d/S01run_voco.sh
sudo rm -f /etc/rc5.d/S01run_voco.sh
sudo rm -f /etc/init.d/run_voco.sh
sudo ln -fs /home/volumio/voco/run_voco.sh /etc/init.d/run_voco.sh
...
sudo ln -fs /etc/init.d/run_voco.sh /etc/rc5.d/S09run_voco.sh
